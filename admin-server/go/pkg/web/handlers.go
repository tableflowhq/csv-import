...
func tusFileHandler(uploadAdditionalStorageHandler, uploadLimitCheck func(*model.Upload, *os.File) error, getAllowedValidateTypes func(string) map[string]bool) *handler.UnroutedHandler {
