...
description: "Trigger a Slack message when new data is changed in the database"
---
...
## Try It Out 🎉
That's it! If everything's set up correctly, you should be good to go. As soon as a new row is added to the specificed table, you'll receive a message to the specified Slack Channel.