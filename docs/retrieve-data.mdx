...
You can also use [Webhooks (coming soon)](https://tableflow.com/docs/webhooks) to get notified when an import has been completed. This allows your backend application to load the imported data as soon as an import has completed.
