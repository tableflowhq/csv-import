...
3. Your system can use the API to [paginate through the imported data](/api/get-import-rows), or [download the data directly as a CSV file](/api/download-import).
