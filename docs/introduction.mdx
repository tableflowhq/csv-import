...
---
TableFlow is an open source data import platform for businesses to onboard their customers. Instead of building CSV import support from scratch, you can embed or link to the TableFlow importer and begin collecting data from customers immediately.
...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="person-running-fast">
    Start collecting data from your customers in minutes.
  </Card>
  <Card title="How It Works" icon="person-chalkboard">
